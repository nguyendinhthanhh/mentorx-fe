...
file_path = r"d:\Mentor X\mentorx-fe\src\pages\course\CourseDetailPage.tsx"
...
old_nav_block = r'\{\/\* Breadcrumb \*\/.*?<\/div>\s*<\/div>'
...
print("Updated CourseDetailPage successfully!")
