  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-3 text-xs font-bold text-slate-700 dark:text-slate-300 transition hover:border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:bg-slate-900/50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-slate-600 dark:hover:bg-slate-800"
      >
      ...
      {open && (
        <>
          ...
          <div
            role="listbox"
            aria-label={t('nav.modeSwitchLabel')}
            className="absolute right-0 top-full z-20 mt-2 w-full min-w-[12rem] origin-top-right rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-2 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none dark:border-slate-700 dark:bg-slate-900 dark:ring-white/10"
          >
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold transition ${
                    active
                      ? 'bg-slate-100 text-slate-900 dark:text-slate-100 dark:bg-slate-800 dark:text-white'
                      : 'text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-slate-900/50 hover:text-blue-600 dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:text-indigo-300'
                  }`}
                >
