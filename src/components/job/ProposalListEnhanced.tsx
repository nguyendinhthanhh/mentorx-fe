...
export default function ProposalListEnhanced({ jobId }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Accepted Banner */}
      {acceptedProposal && (
        <div className="rounded-2xl border border-emerald-200 dark:border-emerald-800/50 bg-emerald-50 dark:bg-emerald-900/30 p-5 flex items-start gap-3">
      ...
      {/* Filter Info */}
      {statusFilter !== 'ALL' && (
        <div className="flex items-center justify-between bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800/50 rounded-xl px-4 py-3">
...
function StatCard({ label, value, icon: Icon, color, active, onClick }: StatCardProps) {
  const colorClasses = {
    slate: active 
      ? 'bg-slate-100 border-slate-300 dark:border-slate-700 ring-2 ring-slate-200' 
      : 'bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:border-slate-700',
    blue: active 
      ? 'bg-blue-100 border-blue-300 ring-2 ring-blue-200' 
      : 'bg-white dark:bg-slate-950 border-blue-200 hover:border-blue-300',
    amber: active 
      ? 'bg-amber-100 dark:bg-amber-900/50 border-amber-300 ring-2 ring-amber-200' 
      : 'bg-white dark:bg-slate-950 border-amber-200 dark:border-amber-800/50 hover:border-amber-300',
    purple: active 
      ? 'bg-emerald-100 dark:bg-emerald-900/50 border-emerald-300 ring-2 ring-emerald-200' 
      : 'bg-white dark:bg-slate-950 border-emerald-200 dark:border-emerald-800/50 hover:border-emerald-300',
    emerald: active 
      ? 'bg-emerald-100 dark:bg-emerald-900/50 border-emerald-300 ring-2 ring-emerald-200' 
      : 'bg-white dark:bg-slate-950 border-emerald-200 dark:border-emerald-800/50 hover:border-emerald-300',
    rose: active 
      ? 'bg-rose-100 border-rose-300 ring-2 ring-rose-200' 
      : 'bg-white dark:bg-slate-950 border-rose-200 hover:border-rose-300',
  }
