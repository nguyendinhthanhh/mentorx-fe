  ...
  return (
    <div className="onb-fade-in-up space-y-8">
      <div className="text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-gray-100 dark:text-white tracking-tight mb-2">Final Touches ✨</h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1 w-full space-y-5">
          <div className="onb-fade-in-up onb-stagger-1">
            ...
            <input
              type="text"
              className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900/50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 dark:border-gray-800 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-100 dark:focus:ring-primary-900/30 transition-all outline-none text-gray-900 dark:text-gray-100 dark:text-white font-bold text-sm"
          ...
          <div className="onb-fade-in-up onb-stagger-2">
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm font-bold text-gray-600 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">Bio</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 onb-fade-in-up onb-stagger-3">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="url"
                  className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-900/50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 dark:border-gray-800 rounded-xl focus:border-primary-500 transition-all outline-none text-gray-900 dark:text-gray-100 dark:text-white text-sm"
