...
export const statusTone: Record<VerificationStatus, string> = {
  [VerificationStatus.NOT_SUBMITTED]: 'bg-slate-100 text-slate-600 dark:text-slate-400',
  [VerificationStatus.PENDING]: 'bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-400',
  [VerificationStatus.APPROVED]: 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-400',
