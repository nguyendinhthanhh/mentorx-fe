...
export default function AdminWithdrawalsPage() {
  ...
  const getStatusColor = (status: WithdrawalStatus) => {
    switch (status) {
      ...
      case WithdrawalStatus.PROCESSING: return 'bg-emerald-50 text-emerald-600 border border-emerald-200 dark:bg-emerald-900/20 dark:border-emerald-800/30 dark:text-emerald-400'
                  ...
                  <tr key={request.id} className="group hover:bg-slate-50/80 dark:hover:bg-slate-800/80 transition-colors">
                    ...
                    <td className="px-8 py-6">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mt-0.5">{request.bankName}</span>
