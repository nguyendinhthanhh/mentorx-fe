...
import { ChatRoomMemberSummary, ChatRoomResponse, ContractResponse, CourseResponse, MentorOfferingResponse, MentorProfileResponse, JobResponse, UserResponse } from '@/types'
...
export default function ContextRail({
  ...
  const avatarUrl = mentorProfile?.user?.avatarUrl || userProfile?.avatarUrl || otherMember?.avatarUrl
  ...
  const profileMeta = mentorProfile
    ? [
        ...
        mentorProfile.yearsOfExperience ? `${mentorProfile.yearsOfExperience}+ years experience` : undefined,
        mentorProfile.languages?.length ? mentorProfile.languages.join(', ') : undefined,
            ...
            <div className="mt-3 space-y-3">
              ...
              {profileSummary && (
                <div className="rounded-xl bg-[#f7f8fe] px-3 py-3">
                  ...
                  <p className="mt-2 text-[13px] leading-6 text-[#52608b]">
                    {profileSummary}
                  </p>
                </div>
              )}
