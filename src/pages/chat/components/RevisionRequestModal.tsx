      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden relative">
        ...
        <div className="p-6 pt-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900">Yêu cầu chỉnh sửa</h2>
              <p className="text-sm text-slate-500">Mô tả lý do bạn muốn Mentor làm lại</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full h-32 rounded-xl border border-slate-200 p-3 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 resize-none"
              disabled={isLoading}
            />
          </div>
