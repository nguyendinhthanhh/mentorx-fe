  ...
  return (
    <div className="space-y-6">
      <Link
        ...
        className="inline-flex items-center gap-1 text-xs font-bold text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:text-emerald-500"
      >
        <ArrowLeft className="w-4 h-4" />
        {t('mentee.complaints.detail.back')}
      </Link>

      <div className="rounded-3xl border border-slate-200 dark:border-slate-800/70 bg-white dark:bg-slate-950 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl border border-emerald-100 dark:border-emerald-900/50 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-500 dark:border-emerald-900/30 dark:bg-emerald-950/30 dark:text-emerald-400">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          <Field label={t('mentee.complaints.fields.title')} required>
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 text-sm font-medium text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:border-emerald-500/40 focus:bg-white dark:bg-slate-950 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:bg-slate-900"
            />
          </Field>
          ...
          <Field label={t('mentee.complaints.fields.respondent')} required hint={t('mentee.complaints.fields.respondentHint')}>
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 text-sm font-medium text-slate-800 dark:text-slate-200 focus:border-emerald-500/40 focus:bg-white dark:bg-slate-950 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:bg-slate-900"
              >
                {selectedMentor
              ...
              {isDropdownOpen && (
                <div className="absolute z-20 mt-1 w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-lg dark:border-slate-700 dark:bg-slate-900">
                  <div className="flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 px-3 py-2 dark:border-slate-800">
                    ...
                    <input
                      ...
                      className="flex-1 bg-transparent text-sm font-medium text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none dark:text-slate-100"
                    />
                    {selectedMentor && (
                      <button
                        type="button"
                    ...
                    {mentorList.map((mentor) => (
                      <li key={mentor.userId}>
                        <button
                          ...
                          className={`w-full px-4 py-2.5 text-left text-sm font-medium transition hover:bg-emerald-50 dark:bg-emerald-900/30 dark:hover:bg-emerald-950/30 ${
                            selectedMentor?.userId === mentor.userId
                              ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 dark:bg-emerald-950/30 dark:text-emerald-300'
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <Field label={t('mentee.complaints.fields.category')} required>
              <select
                ...
                className="w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 text-sm font-bold text-slate-700 dark:text-slate-300 focus:border-emerald-500/40 focus:bg-white dark:bg-slate-950 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:focus:bg-slate-900"
              >
          ...
          <Field label={t('mentee.complaints.fields.description')} required hint={t('mentee.complaints.fields.descriptionHint')}>
            <textarea
              ...
              className="w-full resize-none rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 px-4 py-3 text-sm font-medium text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:border-emerald-500/40 focus:bg-white dark:bg-slate-950 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:bg-slate-900"
            />
          </Field>
          ...
          <div className="flex flex-wrap items-center justify-end gap-3">
            <Link
              to="/profile/complaints"
              className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-5 py-2.5 text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
            >
...
function Field({
  ...
  return (
    <label className="block">
      <span className="flex items-center justify-between text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">
        <span>
          {label}
