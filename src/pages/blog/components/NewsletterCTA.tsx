...
export function NewsletterCTA({
  ...
  return (
    <section className="relative overflow-hidden rounded-[30px] border border-emerald-300/40 bg-gradient-to-br from-slate-900 via-emerald-900 to-blue-900 p-6 text-white shadow-[0_20px_55px_rgba(15,23,42,0.35)] sm:p-8">
      <div className="absolute -left-16 -top-10 h-48 w-48 rounded-full bg-emerald-400/20 blur-3xl" />
